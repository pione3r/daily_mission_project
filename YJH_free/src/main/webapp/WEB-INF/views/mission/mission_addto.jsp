...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div style="margin:20px;">
		<h4 class="card-title" style="font-weight:800; margin-bottom:30px;">일일 미션 함께 하기</h4>
		<form name=form1 action="http://localhost:8080/free/mission/addto/" method="post">
			<div class="mb-3">
			  <label for="formGroupExampleInput" class="form-label" style="font-weight:600;">미션명</label>
			  <input type="text" class="form-control" id="formGroupExampleInput" name="id" readonly	value="${param.id}" />
			</div>
			<div class="mb-3">
			  <label for="formGroupExampleInput" class="form-label" style="font-weight:600;">미션명</label>
			  <input type="text" class="form-control" id="formGroupExampleInput2" name="missionname" readonly value="${param.missionname}" />
			</div>
			<div class="mb-3">
			  <label for="formGroupExampleInput2" class="form-label" style="font-weight:600;">목표</label>
			  <input type="text" class="form-control" id="formGroupExampleInput3" name="goal" readonly value="${param.goal}" />
			</div>
			<div class="mb-3">
			  <label for="formGroupExampleInput3" class="form-label" style="font-weight:600;">보상</label>
			  <input type="text" class="form-control" id="formGroupExampleInput4" name="reward" readonly value="${param.reward}" />
			</div>
